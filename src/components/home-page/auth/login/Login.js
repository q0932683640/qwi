...
function Login() {
    ...
    let showRegister = () => {
        dispatch(actionCreator("authRegister"));
    }
                        ...
                        <div className="form">
                            ...
                            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                ...
                                <FormGroup className="text-center">
                                    {/* <Form.Label className="pl-2 pr-2">Forgot password? <a href="#">Click here</a></Form.Label>  */}
                                    <Form.Label className="pl-2 pr-2">New user? <a href="#" onClick={showRegister}>Register!</a></Form.Label>                                                        
                                </FormGroup>
                                <FormGroup className="text-center">
