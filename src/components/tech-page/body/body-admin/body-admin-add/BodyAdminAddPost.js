                            ...
                            <Form>
                                ...
                                <Form.Group controlId="formContent">
                                    ...
                                    <div className="rich-text">
                                        <button className="btn btn-outline-dark" onClick={_onBoldClick}>B</button>
                                        <button className="btn btn-outline-dark" onClick={_onUnderlineClick}>U</button>
                                        <button className="btn btn-outline-dark" onClick={_onItalicClick}><em>I</em></button>
                                        <button className="btn btn-outline-dark" onClick={_onCodeClick}>CODE</button>
